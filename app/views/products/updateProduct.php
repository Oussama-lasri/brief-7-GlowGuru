    ...
    <div class="row" id="col">
        <div class="col-md-6 mx-auto">
            <div class="card card-body bg-light mt-3 m-5">
                ...
                <form action="<?php echo URLROOT; ?>/products/updateProduct/<?php echo $data['id_produit'] ?>" method="post" id="add_form">
                    <hr class="mt-4 mb-4">
                    <div class="form-group" id="show_item">
                        ...
                        <img class="w-100 my-3" src="<?php echo URLROOT ?>/img/hb.jpg" alt=""/>
